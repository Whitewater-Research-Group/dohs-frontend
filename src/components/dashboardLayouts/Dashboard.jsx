...
const NotificationsPanel = ({ isOpen, onClose }) => {
    const notifications = [
      { id: 1, title: 'Yellow Fever in Kano', time: '30 mins ago', type: 'alert' },
      { id: 2, title: 'Report reviewed by Dr. Dale', time: '45 minutes ago', type: 'info' },
      { id: 3, title: 'Ebola outbreak in Lagos', time: '1 hour ago', type: 'alert' },
    ];
...
const DashboardLayout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <Header toggleNotifications={() => setNotificationsOpen(!notificationsOpen)} />
      <NotificationsPanel
