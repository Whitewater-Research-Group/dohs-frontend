    ...
    return (
        <section className="mt-14 mb-10 py-12">
            <div className="ml-40 flex space-x-20">
                ...
                <form className="grid grid-cols-2 gap-x-20 mt-5">
                    <input
                        type="email"
                        className="ml-16 w-full md:w-1/2 lg:w-full h-1/2 p-5 pr-60 border rounded-md focus:outline-none focus:ring-2 focus:ring-teal-400"
                        placeholder="Enter your email"
                    />
                    <div className='-mt-6 ml-14 flex items-center text-white font-sans font-bold'>
