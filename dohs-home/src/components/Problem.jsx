    ...
    return (
        <section className="py-12">
            <div className="container mx-auto px-4 font-sans text-darkCoal">
                ...
                <p className="">
                    For most sub-Saharan countries, case management systems and incident reporting systems for animals, plants, and the environment are either not operational or do not share real-time data to rouse technical attention on community health. The gap in effective outreach response from intersectoral spillovers to and from other sectors must be integrated intelligently and analytically into every OH surveillance system without waiting for rippling effects or receding to prolonged human assessment. Consequently, DOH systems need to advance into defining systems of information exchanges between the stakeholder agencies to promote interagency participation and close stakeholder inclusion gaps. Even more, to be able to assess country-level preparedness for localized and innovative adoption of OH systems.
                </p>
            </div>
        </section>
    );
